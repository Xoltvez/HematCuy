...
<body>
    ...
    <div class="split-left">
        <div class="auth-container">
            ...
            <h2 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 0.5rem;">Selamat datang kembali 👋</h2>
            <p style="color: #a1a1aa; font-size: 0.95rem; margin-bottom: 2.5rem;">Masuk untuk melanjutkan pengaturan keuanganmu.</p>
            ...
            <form method="POST" action="{{ route('login') }}" onsubmit="const btn = this.querySelector('button[type=submit]'); btn.disabled = true; btn.innerHTML = 'Memeriksa...';">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div style="text-align: right; margin-top: 0.5rem;">
                        <a href="{{ route('password.request') }}" style="color: #3b82f6; font-size: 0.85rem; text-decoration: none;">Lupa password?</a>
                    </div>
                </div>

                <div style="margin-bottom: 1.5rem; display: flex; align-items: center;">
                    <input type="checkbox" name="remember" id="remember" value="1" {{ old('remember') ? 'checked' : '' }} style="margin-right: 0.5rem;">
                    <label for="remember" style="margin-bottom: 0; cursor: pointer;">Ingat Saya</label>
                </div>
            ...
            <div style="text-align: center; margin-top: 2rem; font-size: 0.95rem; color: #a1a1aa;">
                Belum punya akun? <a href="{{ route('register') }}" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Daftar sekarang</a>
            </div>
        </div>
    </div>
    ...
    <div class="split-right">
        ...
        <div class="right-text" style="width: 100%; z-index: 10;">
            ...
            <p style="font-size: 1.2rem; color: #a1a1aa; line-height: 1.6; max-width: 480px;">
                Atur uang bulanan anda agar terstruktur
            </p>
        </div>
    </div>
