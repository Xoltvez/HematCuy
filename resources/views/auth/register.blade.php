...
<body>
    ...
    <div class="split-left">
        <div class="auth-container">
            <a href="/" class="logo-nav">
                <img src="{{ asset('images/logohematcuy.png') }}" alt="HematCuy Logo" width="28" height="28" style="border-radius: 6px; object-fit: contain;">
                HematCuy
            </a>

            <h2 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 0.5rem;">Buat Akun Baru ✨</h2>
            <p style="color: #a1a1aa; font-size: 0.95rem; margin-bottom: 2rem;">Mulai catat keuangan dengan rapi dan cerdas.</p>
            ...
            <form method="POST" action="{{ route('register') }}" onsubmit="return validateForm(this, event)">
                @csrf
                <div class="form-group">
                    <label for="name">Nama Panggilan</label>
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus class="form-control" placeholder="Cth: Faizz">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input id="password" type="password" name="password" required class="form-control" placeholder="Minimal 8 karakter" onkeyup="checkPassword(this.value)">
            ...
            <div style="text-align: center; margin-top: 2rem; font-size: 0.95rem; color: #a1a1aa;">
                Sudah punya akun? <a href="{{ route('login') }}" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Masuk di sini</a>
            </div>
        </div>
    </div>
    ...
    <div class="split-right">
        ...
        <div class="right-text" style="width: 100%; z-index: 10;">
            <h2 style="font-size: 2.3rem; font-weight: 800; color: #ffffff; line-height: 1.2; margin-bottom: 1.25rem; letter-spacing: -1px;">
                Mulai Kelola Keuanganmu Hari Ini
            </h2>
            <p style="font-size: 1.2rem; color: #a1a1aa; line-height: 1.6; max-width: 480px;">
                Bergabunglah dengan HematCuy dan kelola keuanganmu
            </p>
        </div>
    </div>
